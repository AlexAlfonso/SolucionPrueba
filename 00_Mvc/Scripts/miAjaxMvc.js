function miAjax(param) {
	...
	if (param == null || param == 0) {
		...
		fetch('https://localhost:44350/Api/Empleados',opciones)
		...
		fetch('https://localhost:44350/Api/Empleados/' + param,opciones)
		.then(respuesta => respuesta.json())
		.then(resultado =>{
		//	resultado.forEach(elemento => {            
...
function miAjaxMvc(param) {
	var apiUrl = 'https://localhost:44350/Api/Empleados/';
				...
				$.ajax(
					{
						...
						url: "_EmpleadosMvcPartialView", // Controller/View
						data: res
						...
						$('#EmpleadosMvcPartialView').empty().append(resDeLaRes);
